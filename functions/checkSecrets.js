...
const consumerAddress = "0x2a7849fe4caf9ea8e3cbfbc8ec162b0cab39f6ca"; // REPLACE this with your Functions consumer address
const subscriptionId = 3661; // REPLACE this with your subscription ID
const donHostedSecretsVersion = 1731739451; // REPLACE with the version of the encrypted secrets executed with uploadSecrets.js
...
const makeRequestSepolia = async () => {
  ...
  const source = fs
    .readFileSync(path.resolve(__dirname, "sources/alpacaBalance.js"))
    .toString();
